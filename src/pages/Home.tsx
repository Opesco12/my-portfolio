    ...
    >
      <div className="md:max-w-6xl mx-auto">
        ...
        >
          ...
          <div>
            <h2
              className="text-lg font-medium  mt-10 md:text-2xl"
              id="projects"
            >
              About Me
            </h2>
            <p className=" leading-relaxed mt-2 text-justify md:text-lg">
              ...
              thoughts and visual preferences. I'm a graduate of Information
              Technology and a self taught programmer exploring life to find my
              path.
            </p>
          </div>
          <div className="flex justify-center gap-5 my-5 md:my-10 sm:justify-start">
